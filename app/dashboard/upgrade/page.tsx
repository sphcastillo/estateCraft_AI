...
function PricingPage() {
  ...
  console.log("Upgrade page ~ hasActiveMembership: ", hasActiveMembership);

  const handleUpgrade = () => {
    if (!user) return;

        // we are giving Stripe two things : email & name 
    ...
    startTransition(async () => {
      ...
      // get sessionId and then redirect to checkout
      ...
      <div className="py-24 sm:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
            Supercharge with EstateCraft AI PRO
          </p>
        </div>
