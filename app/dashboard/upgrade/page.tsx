  ...
  return (
    <div>
      <div className="py-24 sm:py-32">
        ...
        <p className="mx-auto mt-6 max-w-2xl px-10 text-center text-lg leading-8 text-gray-600 text-pretty">
          Choose an afforable plan that is packed with the best features for
          interacting with your PDFs, enhancing productivity, and streamling
          your workflow.
        </p>
        ...
        <div className="max-w-md mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 md:max-w-2xl gap-8 lg:max-w-4xl">
          ...
          <div className="ring-2 ring-indigo-600 rounded-3xl p-8 ">
            ...
            <p className="mt-4 text-sm leading-6 text-gray-600">
              Maximize Productivity with Premium Features
            </p>
            <p className="mt-6 flex items-baseline gap-x-1">
              <span className="text-4xl font-bold tracking-tight text-gray-900">
                $5.99
            ...
            <Button
              className="bg-indigo-600 w-full text-white shadow-sm hover:bg-indigo-50 mt-6 block rounded-md px-3 py-2 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
